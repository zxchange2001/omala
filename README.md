...
- [QA-Pilot](https://github.com/reid41/QA-Pilot) (An interactive chat tool that leverages Ollama(or openAI) models for rapid understanding and navigation of GitHub code repository or compressed file resources)
