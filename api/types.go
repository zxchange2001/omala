...
type Options struct {
	...
	ToolCallsStart   string   `json:"tool_calls_start,omitempty"`
	ToolCallsEnd     string   `json:"tool_calls_end,omitempty"`
	ToolCallsFormat  string   `json:"tool_calls_format,omitempty"`
}
